...
COLOR_SPOTLIGHT_CYAN   = one_ui.COLOR_ONEUI_BLUE
COLOR_SPOTLIGHT_GREEN  = one_ui.COLOR_ONEUI_GREEN
COLOR_SPOTLIGHT_PURPLE = one_ui.COLOR_ONEUI_PURPLE
COLOR_SPOTLIGHT_AMBER  = one_ui.COLOR_ONEUI_AMBER
COLOR_CARD_BG          = one_ui.COLOR_ONEUI_CARD
COLOR_CARD_BORDER      = one_ui.COLOR_ONEUI_BORDER
COLOR_TEXT_MAIN        = one_ui.COLOR_ONEUI_TEXT
COLOR_TEXT_MUTED       = one_ui.COLOR_ONEUI_TEXT_SEC
